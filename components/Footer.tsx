        ...
        <div className="grid gap-10 md:grid-cols-12 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center h-10 w-10 rounded-2xl bg-gradient-to-br from-[#c79d47] via-[#fcc74f] to-[#a87f30] text-slate-950 font-black text-lg shadow-md">
                50
              </div>
              <span className="font-black text-xl tracking-tight text-white">
                AGENDA <span className="text-[#c79d47]">50/50</span>
              </span>
            </div>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-bold text-slate-300">
              <li><a href="#acuerdo" className="hover:text-[#c79d47] transition">El Acuerdo de Sucre</a></li>
              <li><a href="#pilares" className="hover:text-[#c79d47] transition">Los 10+ Pilares Temáticos</a></li>
              <li><a href="#monitor" className="hover:text-[#c79d47] transition">Monitor 50/50 y Simulador</a></li>
              <li><a href="#ruta" className="hover:text-[#c79d47] transition">Cronograma y Ley 154</a></li>
              <li><a href="#descargas" className="hover:text-[#c79d47] transition">Centro de Descargas (PDF)</a></li>
            </ul>
          </div>
